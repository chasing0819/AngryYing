...
public class GameManager : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        switch (CurrentGameState)
        {
            ...
            case GameState.Start:
                GUI.Label(new Rect(0, 150, 200, 100), "点击屏幕开始 愤怒的盈盈要去找寻她的幸福之旅");
                break;
            case GameState.BirdMovingToSlingshot:
                GUI.Label(new Rect(0, 150, 200, 100), "愤怒的盈盈要出发了");
                break;
            case GameState.Playing:
                GUI.Label(new Rect(0, 150, 200, 100), "去吧 皮卡丘！飞行时记得点击屏幕释放盈盈分身");
                break;
            case GameState.Won:
                GUI.Label(new Rect(0, 150, 200, 100), "厉害了 盈盈和王子过上了幸福的生活，点击重来");
                break;
            case GameState.Lost:
                GUI.Label(new Rect(0, 150, 200, 100), "很遗憾，盈盈撞得找不着北了");
                break;
            default:
                break;
        }
